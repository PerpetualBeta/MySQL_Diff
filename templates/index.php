...
<?php
  ...
  echo '<p class="inverse">Comparing the database: &ldquo;<strong>' . $diffs['left'] . '</strong>&rdquo; with: &ldquo;<strong>' . $diffs['right'] . '</strong>&rdquo;<br />Using configuration file: &ldquo;' . $config_used . '&rdquo;</p>';
